...
def get_normalized_data_for_test(data_image, data_type):
    clip_min = [[-25.0, -32.5], [0 for _ in range(data_image.shape[0])], [0 for _ in range(data_image.shape[0])]]
    clip_max = [[0, 0], [10000 for _ in range(data_image.shape[0])], [10000 for _ in range(data_image.shape[0])]]
    max_val = 1
    scale = 10000
